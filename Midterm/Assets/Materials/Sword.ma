...
//Name: Sword.ma
//Last modified: Sat, Jul 26, 2014 08:04:22 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.45119133610822 21.000000000000032 39.447297478554582 ;
	setAttr ".r" -type "double3" -27.938352729602364 -4.9999999999999947 0 ;
	setAttr ".rp" -type "double3" 0 0 -3.5527136788005009e-15 ;
	setAttr ".rpt" -type "double3" -4.3983607710227722e-16 3.7227541554063841e-15 3.6116963853862836e-15 ;
...
createNode mesh -n "SwordShape" -p "Sword";
	...
	setAttr ".pt[468]" -type "float3" 0 0 0.024498409 ;
	setAttr ".pt[471]" -type "float3" 0 0 -0.025242204 ;
	setAttr ".pt[477]" -type "float3" 0 0 0.024498409 ;
	setAttr ".pt[478]" -type "float3" 0 0 -0.025242204 ;
	setAttr -s 482 ".vt";
